...
Neu schreiben als Arrow Dataset, gruppiert nach Date und ohne Duplikate. Ich benutze ein Foor-Loop, weil der Datensatz zu groß ist um komplett in RAM zu passen. Daher suche ich in jedem Jahr einzeln nach Duplikaten.
```{r}
