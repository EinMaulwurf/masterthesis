...
ggsave("./Output/plot_de_glasfaser_1km.pdf", plot = p, width = 5, height = 7)
```
...
breitband_1km_arrow %>%
  select(date, down_fn_hh_ftthb_1000) %>%
  filter(date == 202312 | date == 201812) %>%
...
ggsave("./Output/plots/plot_verteilung_glasfaser_2018_2023.pdf", width = 5, height = 3)
```
