...
zensus_gebäudetyp <- readxl::read_xlsx("./Daten/Zensus/Regionaltabelle_Gebaeude_Wohnungen.xlsx", 
...
zensus_gebäudetyp %>%
  write_parquet("./Daten/Zensus/zensus_gebäudetypen.parquet")
...
cells_gemeinden_gebäudetypen %>%
  write_parquet("./Daten/Geodaten/Raster_1km_gemeinden_gebäudetypen.parquet")
```
