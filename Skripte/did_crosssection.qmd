...
erklärende_imp <- read_parquet("../Daten/Sonstige/erklärende_imp.parquet")
...
```{r}
#data_kauf_crosssection %>% write_parquet("../Daten/Sonstige/data_kauf_crosssection_test.parquet")
#data_kauf_crosssection <- read_parquet("../Daten/Sonstige/data_kauf_crosssection_test.parquet")
```
