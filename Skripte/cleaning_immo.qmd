...
```{r}
import_hk <- read_parquet("../Daten/RWI_GEO_REX/Daten_Kauf/HK_SUF_ohneText.parquet",
...
```{r}
import_wk <- read_parquet("../Daten/RWI_GEO_REX/Daten_Kauf/WK_SUF_ohneText.parquet",
                          col_select = all_of(col_kauf)) %>%
  haven::zap_labels() %>%
  haven::zap_formats() %>%
  haven::zap_label() %>%
...
```{r}
data_kauf <- bind_rows(import_hk_clean, import_wk_clean)

data_kauf %>%
  write_parquet("../Daten/RWI_GEO_REX/Daten_Kauf/data_kauf.parquet")
```
...
```{r}
import_hm <- read_parquet("../Daten/RWI_GEO_REX/Daten_Miete/HM_SUF_ohneText.parquet",
...
```{r}
import_wm <- read_parquet("../Daten/RWI_GEO_REX/Daten_Miete/WM_SUF_ohneText.parquet",
                          col_select = all_of(col_miete)) %>%
  haven::zap_labels() %>%
  haven::zap_formats() %>%
  haven::zap_label() %>%
...
```{r}
data_miete <- bind_rows(import_hm_clean, import_wm_clean)

data_miete %>%
  write_parquet("../Daten/RWI_GEO_REX/Daten_Miete/data_miete.parquet")
```
...
```{r}
# Einlesen
data_kauf <- read_parquet("../Daten/RWI_GEO_REX/Daten_Kauf/data_kauf.parquet")
...
data_kauf_complete %>%
  write_parquet("../Daten/RWI_GEO_REX/Daten_Kauf/data_kauf_complete.parquet")
```
...
```{r}
# Einlesen
data_miete <- read_parquet("../Daten/RWI_GEO_REX/Daten_Miete/data_miete.parquet")
...
data_miete_complete %>%
  write_parquet("../Daten/RWI_GEO_REX/Daten_Miete/data_miete_complete.parquet")
```
