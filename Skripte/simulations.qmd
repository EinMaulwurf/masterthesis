...
```{r}
dat <- simulate_panel(n_ids = 1000, n_time = 10, base_slopes = c(1.005,1),
...
cs21_agg_dyn_honest_rel <- honest_did(es = cs21_agg_dyn,
                          ...
                          Mbarvec = seq(from = 60, to = 70, length.out = 11),
                          grid.ub = 10e3, grid.lb = -10e3, gridPoints = 10e4
                          )
