...
breitband_100m_arrow <- open_dataset("./data/Breitbandatlas/Raster_100m/")
breitband_1km_arrow <- open_dataset("./data/Breitbandatlas/Raster_1km/")
...
breitband_1km_max_speed <- read_parquet("./data/Breitbandatlas/Raster_1km_max_speed.parquet")

# Laden des fehlerhaften Koordinaten
breitband_1km_problems <- read_parquet("./data/Breitbandatlas/Raster_1km_problems.parquet")
```
...
```{r}
read_parquet("./data/Breitbandatlas/Raster_1km_got_fiber_date.parquet") %>%
