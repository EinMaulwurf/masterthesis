...
ggsave("./output/plots/karten/plot_runkel_miete_completeness.pdf", width = 3, height = 3)
...
ggsave("./output/plots/karten/plot_darmstadt_miete_completeness.pdf", width = 3, height = 3)
```
...
data_kauf_final %>%
  ...
  coord_cartesian(ylim = c(0, 500000), xlim = c(-10, 6)) +
