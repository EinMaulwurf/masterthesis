...
```{r}
import_hk <- read_parquet("./data/RWI_GEO_REDX/Daten_Kauf/HK_SUF_ohneText.parquet",
...
import_wk <- read_parquet("./data/RWI_GEO_REDX/Daten_Kauf/WK_SUF_ohneText.parquet",
                          col_select = all_of(col_kauf)) %>%
  haven::zap_labels() %>%
  haven::zap_formats() %>%
  haven::zap_label() %>%
...
data_kauf %>%
  write_parquet("./data/RWI_GEO_REDX/Daten_Kauf/data_kauf.parquet")
```
...
```{r}
import_hm <- read_parquet("./data/RWI_GEO_REDX/Daten_Miete/HM_SUF_ohneText.parquet",
...
import_wm <- read_parquet("./data/RWI_GEO_REDX/Daten_Miete/WM_SUF_ohneText.parquet",
                          col_select = all_of(col_miete)) %>%
  haven::zap_labels() %>%
  haven::zap_formats() %>%
  haven::zap_label() %>%
...
data_miete %>%
  write_parquet("./data/RWI_GEO_REDX/Daten_Miete/data_miete.parquet")
```
...
data_kauf_complete %>%
  write_parquet("./data/RWI_GEO_REDX/Daten_Kauf/data_kauf_complete.parquet")
```
...
```{r}
# Einlesen
data_miete <- read_parquet("./data/RWI_GEO_REDX/Daten_Miete/data_miete.parquet")
...
data_miete_complete %>%
  write_parquet("./data/RWI_GEO_REDX/Daten_Miete/data_miete_complete.parquet")
```
