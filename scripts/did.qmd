...
```{r}
dates_pseudo_halbjahr <- read_parquet("./data/dates_pseudo_halbjahr.parquet")

data_miete_complete <- read_parquet("./data/RWI_GEO_REDX/Daten_Miete/data_miete_complete.parquet")
data_kauf_complete <- read_parquet("./data/RWI_GEO_REDX/Daten_Kauf/data_kauf_complete.parquet")
```
...
# Save results
write_parquet(models_räumlich_miete_agg_dyn_tidy, "./data/Sonstige/models_räumlich_miete_agg_dyn_tidy.parquet")
#models_räumlich_miete_agg_dyn_tidy <- read_parquet("./data/Sonstige/models_räumlich_miete_agg_dyn_tidy.parquet")
```
...
# Save results
write_parquet(models_räumlich_kauf_agg_dyn_tidy, "./data/Sonstige/models_räumlich_kauf_agg_dyn_tidy.parquet")
#models_räumlich_kauf_agg_dyn_tidy <- read_parquet("./data/Sonstige/models_räumlich_kauf_agg_dyn_tidy.parquet")
```
...
# Save results
write_parquet(models_gebäudetyp_miete_agg_dyn_tidy, "./data/Sonstige/models_gebäudetyp_miete_agg_dyn_tidy.parquet")
#models_räumlich_miete_agg_dyn_tidy <- read_parquet("./data/Sonstige/models_räumlich_miete_agg_dyn_tidy.parquet")
```
...
# Save results
write_parquet(models_gebäudetyp_kauf_agg_dyn_tidy, "./data/Sonstige/models_gebäudetyp_kauf_agg_dyn_tidy.parquet")
#models_gebäudetyp_kauf_agg_dyn_tidy <- read_parquet("./data/Sonstige/models_gebäudetyp_kauf_agg_dyn_tidy.parquet")
```
...
# Save results
write_parquet(models_miete_agg_dyn_tidy, "./data/Sonstige/models_miete_agg_dyn_tidy.parquet")
#models_miete_agg_dyn_tidy <- read_parquet("./data/Sonstige/models_miete_agg_dyn_tidy.parquet")
```
...
# Save results
write_parquet(models_kauf_agg_dyn_tidy, "./data/Sonstige/models_kauf_agg_dyn_tidy.parquet")
#models_kauf_agg_dyn_tidy <- read_parquet("./data/Sonstige/models_kauf_agg_dyn_tidy.parquet")
```
...
```{r}
min_wage <- read_rds("./data/Sonstige/min_wage_CS.rds")
...
```{r}
max_speed <- read_parquet("./data/Breitbandatlas/Raster_1km_max_speed.parquet")
