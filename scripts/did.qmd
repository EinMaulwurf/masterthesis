...
data_miete_complete <- read_parquet("./data/RWI_GEO_RED/Daten_Miete/data_miete_complete.parquet")
data_kauf_complete <- read_parquet("./data/RWI_GEO_RED/Daten_Kauf/data_kauf_complete.parquet")
```
