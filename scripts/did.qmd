...
# Save results
write_parquet(models_gebäudetyp_miete_agg_dyn_tidy, "./data/processed/Sonstige/models_gebäudetyp_miete_agg_dyn_tidy.parquet")
#models_räumlich_miete_agg_dyn_tidy <- read_parquet("./data/processed/Sonstige/models_räumlich_miete_agg_dyn_tidy.parquet")
```
...
# Save results
write_parquet(models_gebäudetyp_kauf_agg_dyn_tidy, "./data/processed/Sonstige/models_gebäudetyp_kauf_agg_dyn_tidy.parquet")
#models_gebäudetyp_kauf_agg_dyn_tidy <- read_parquet("./data/processed/Sonstige/models_gebäudetyp_kauf_agg_dyn_tidy.parquet")
```
