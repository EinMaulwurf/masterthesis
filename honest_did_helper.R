...
# Neu, von https://github.com/bcallaway11/did/blob/master/R/honest_did/honest_did.R
...
#' @export
honest_did_new <- function(es, ...) {
  UseMethod("honest_did_new", es)
}
...
#' 
#' @export
honest_did_new.AGGTEobj <- function(es,
                                e=0,
                                type=c("smoothness", "relative_magnitude"),
                                method=NULL,
